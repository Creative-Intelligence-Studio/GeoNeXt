...
def add_output_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--resume_from", type=str, default=None, help="Resume training from an accelerate state checkpoint path, or use 'latest' to auto-pick the newest one under output_path.")
    return parser
